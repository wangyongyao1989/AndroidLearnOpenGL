...
#ifndef ANDROIDLEARNOPENGL_GLSLRandomFunction_H
#define ANDROIDLEARNOPENGL_GLSLRandomFunction_H

#include <vector>
#include "GLSLShader.h"

static float DRVertices[] = {
...
static const float kDRVerticek[8] = {
        -1.f, 1.f,
        -1.f, -1.f,
        1.f, 1.f,
        1.f, -1.f
...
#endif //ANDROIDLEARNOPENGL_GLSLRandomFunction_H
