...
#ifndef ANDROIDLEARNOPENGL_GLCOLORFUNCTION_H
#define ANDROIDLEARNOPENGL_GLCOLORFUNCTION_H

#include <vector>
#include "GLSLShader.h"

static float CFVertices[] = {
...
static const float kCFVerticek[8] = {
        -1.f, 1.f,
        -1.f, -1.f,
        1.f, 1.f,
        1.f, -1.f
...
#endif //ANDROIDLEARNOPENGL_GLCOLORFUNCTION_H
