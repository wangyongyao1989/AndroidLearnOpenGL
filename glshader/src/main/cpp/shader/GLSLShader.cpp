 ...
 * @return
 */
GLuint GLSLShader::loadShader(GLenum shaderType, const char *pSource) {
...
bool GLSLShader::getSharderPath(const char *vertexPath, const char *fragmentPath) {
...
void GLSLShader::checkGlError(const char *op) {
...
void GLSLShader::setGVertexShaderCode(const char *gVertexShaderCode) {
    GLSLShader::gVertexShaderCode = gVertexShaderCode;
}

void GLSLShader::setGFragmentShaderCode(const char *gFragmentShaderCode) {
    GLSLShader::gFragmentShaderCode = gFragmentShaderCode;
}
