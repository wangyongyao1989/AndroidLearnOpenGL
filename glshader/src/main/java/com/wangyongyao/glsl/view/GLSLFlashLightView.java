...
public class GLSLFlashLightView extends GLSurfaceView implements GLSurfaceView.Renderer {

    private GestureDetector gestureDetector;
    private ScaleGestureDetector scaleGestureDetector;

    private static String TAG = GLSLFlashLightView.class.getSimpleName();
    ...
    public GLSLFlashLightView(Context context, GLSLCallJni jniCall) {
        super(context);
        mContext = context;
    ...
    public GLSLFlashLightView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    private void init() {
        ...
        String fragPath = GLSLShowUtil.getModelFilePath(mContext, "flash_light_cube_fragment.glsl");
        String vertexPath = GLSLShowUtil.getModelFilePath(mContext, "flash_light_cube_vertex.glsl");
        String colorFragPath = GLSLShowUtil.getModelFilePath(mContext, "flash_light_color_fragment.glsl");
        String colorVertexPath = GLSLShowUtil.getModelFilePath(mContext, "flash_light_color_vertex.glsl");
        String picSrc1 = GLSLShowUtil.getModelFilePath(mContext, "diffuse_map_container2.png");
        String picSrc2 = GLSLShowUtil.getModelFilePath(mContext, "specular_container2.png");
