...
public class GLSeniorStencilTestView extends GLSurfaceView implements GLSurfaceView.Renderer {

    private GestureDetector gestureDetector;
    private ScaleGestureDetector scaleGestureDetector;

    private static String TAG = GLSeniorStencilTestView.class.getSimpleName();
    ...
    public GLSeniorStencilTestView(Context context, GLSeniorCallJni jniCall) {
        super(context);
        mContext = context;
    ...
    public GLSeniorStencilTestView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
