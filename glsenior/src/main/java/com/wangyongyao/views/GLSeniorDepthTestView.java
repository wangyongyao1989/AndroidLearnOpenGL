...
public class GLSeniorDepthTestView extends GLSurfaceView implements GLSurfaceView.Renderer {

    private GestureDetector gestureDetector;
    private ScaleGestureDetector scaleGestureDetector;

    private static String TAG = GLSeniorDepthTestView.class.getSimpleName();
    ...
    public GLSeniorDepthTestView(Context context, GLSeniorCallJni jniCall) {
        super(context);
        mContext = context;
    ...
    public GLSeniorDepthTestView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
...
//                        + "===getFocusY" + detector.getFocusY());
                mGLSeniorCallJni.depthTestOnScale(scaleFactor, detector.getFocusX()
...
//                Log.e(TAG, "onScaleBegin: " + detector);
                mGLSeniorCallJni.depthTestOnScale(detector.getScaleFactor(), detector.getFocusX()
...
//                Log.e(TAG, "onScaleEnd: " + detector);
    ...
    public void onDrawFrame(GL10 gl) {
        if (mGLSeniorCallJni != null)
            mGLSeniorCallJni.depthTestOpenGLRenderFrame();
    }

    public void onSurfaceChanged(GL10 gl, int width, int height) {
        if (mGLSeniorCallJni != null)
            mGLSeniorCallJni.initDepthTestOpenGl(width, height);
    }
