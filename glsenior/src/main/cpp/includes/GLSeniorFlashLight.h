...
* 立方体
*/
const float FlashLight3DVertices[] = {
...
const vec3 FlashLight3DPos(1.2f, 1.0f, 2.0f);
// positions all containers
const vec3 FlashLight3DCubePositions[] = {
...
private:
    ...
    GLSeniorShader *lightColorShader;
    GLSeniorShader *lightCubeShader;
