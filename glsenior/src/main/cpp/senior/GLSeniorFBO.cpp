...
#include <iostream>
#include "../includes/GLSeniorFBO.h"
...
bool GLSeniorFBO::setSharderPath(const char *vertexPath, const char *fragmentPath) {
...
void GLSeniorFBO::setMoveXY(float dx, float dy, int actionMode) {
...
void GLSeniorFBO::setOnScale(float scaleFactor, float focusX, float focusY, int actionMode) {
...
void GLSeniorFBO::printGLString(const char *name, GLenum s) {
    const char *v = (const char *) glGetString(s);
    LOGI("OpenGL %s = %s\n", name, v);
}

void GLSeniorFBO::checkGlError(const char *op) {
 ...
 * @return
 */
int GLSeniorFBO::loadTexture(unsigned char *data, int width, int height, GLenum format) {
