...
* 立方体
*/
const float diffuseReflectionVertices[] = {
        -0.5f, -0.5f, -0.5f,
        0.5f, -0.5f, -0.5f,
        0.5f, 0.5f, -0.5f,
        0.5f, 0.5f, -0.5f,
...
const vec3 diffuseReflectionLightPos(1.2f, 1.0f, 2.0f);

class OpenglesDiffuseReflectionLight {
...
public:
    ...
    OpenglesDiffuseReflectionLight();
