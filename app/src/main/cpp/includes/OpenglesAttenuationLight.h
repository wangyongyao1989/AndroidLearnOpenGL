...
* 立方体
*/
const float AttenuationLightVertices[] = {
...
const vec3 AttenuationLightLightPos(1.2f, 1.0f, 2.0f);
// positions all containers
const vec3 AttenuationLightCubePositions[] = {
...
class OpenglesAttenuationLight {
