...
* 立方体
*/
const float DirectionLightVertices[] = {
...
const vec3 DirectionLightLightPos(1.2f, 1.0f, 2.0f);
// positions all containers
const vec3 DirectionLightCubePositions[] = {
