...
public class GLDiffuseMapView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public GLDiffuseMapView(Context context, GLFounationJniCall jniCall) {
        super(context);
        mContext = context;
        mJniCall = jniCall;
        init();
    ...
    private void init() {
        ...
        String fragPath = OpenGLFoundationUtil.getModelFilePath(mContext, "diffuse_map_cube_fragment.glsl");
        String vertexPath = OpenGLFoundationUtil.getModelFilePath(mContext, "diffuse_map_cube_vertex.glsl");
        String colorFragPath = OpenGLFoundationUtil.getModelFilePath(mContext, "diffuse_map_color_fragment.glsl");
        String colorVertexPath = OpenGLFoundationUtil.getModelFilePath(mContext, "diffuse_map_color_vertex.glsl");
